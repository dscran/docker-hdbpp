...
function initConf(conf) {
	...
	if (conf=='<first-configuration>') {
		plotService = "./lib/service/hdb_plot_service.php?conf=maxi";
		treeService = "./lib/service/hdb_tree_service.php?conf=maxi";
		exportService = "<your_absolute_path>/lib/service/hdbpp_export_service.php?conf=maxi"
	}
