...
PARTITION BY RANGE COLUMNS(data_time) (
	PARTITION p000 VALUES LESS THAN ('2015-01-01'),
        ...
        PARTITION p2019_01_02 VALUES LESS THAN ('2019-03-01'),
        PARTITION p2019_03_04 VALUES LESS THAN ('2019-05-01'),
        PARTITION p2019_05_06 VALUES LESS THAN ('2019-07-01'),
        PARTITION p2019_07_08 VALUES LESS THAN ('2019-09-01'),
        PARTITION p2019_09_10 VALUES LESS THAN ('2019-11-01'),
        PARTITION p2019_11_12 VALUES LESS THAN ('2020-01-01'),
        PARTITION p2020_01_02 VALUES LESS THAN ('2020-03-01'),
        PARTITION p2020_03_04 VALUES LESS THAN ('2020-05-01'),
        PARTITION p2020_05_06 VALUES LESS THAN ('2020-07-01'),
        PARTITION p2020_07_08 VALUES LESS THAN ('2020-09-01'),
        PARTITION p2020_09_10 VALUES LESS THAN ('2020-11-01'),
        PARTITION p2020_11_12 VALUES LESS THAN ('2021-01-01'),
        PARTITION p2021_01_02 VALUES LESS THAN ('2021-03-01'),
        PARTITION p2021_03_04 VALUES LESS THAN ('2021-05-01'),
        PARTITION p2021_05_06 VALUES LESS THAN ('2021-07-01'),
        PARTITION p2021_07_08 VALUES LESS THAN ('2021-09-01'),
        PARTITION p2021_09_10 VALUES LESS THAN ('2021-11-01'),
        PARTITION p2021_11_12 VALUES LESS THAN ('2022-01-01'),
        PARTITION future       VALUES LESS THAN MAXVALUE
);
...
data_time DATETIME(6) NOT NULL,
recv_time DATETIME(6) NOT NULL,
value_r VARCHAR(6384) DEFAULT NULL,
quality TINYINT(1) DEFAULT NULL,
att_error_desc_id INT UNSIGNED NULL DEFAULT NULL,
PRIMARY KEY(att_conf_id, data_time)
...
recv_time DATETIME(6) NOT NULL,
value_r VARCHAR(6384) DEFAULT NULL,
value_w VARCHAR(6384) DEFAULT NULL,
quality TINYINT(1) DEFAULT NULL,
att_error_desc_id INT UNSIGNED NULL DEFAULT NULL,
PRIMARY KEY(att_conf_id, data_time)
